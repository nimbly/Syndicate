...
{
	/**
	 * @param PublisherInterface $publisher The publisher instance to publish messages to.
	 * @param string $topic The topic name, queue name, queue URL, or location to publish messages to. This is highly dependent on the Publisher being used.
	 */
